...
const App: React.FC = () => {
  ...
  const handleNewScene = (type: 'Eagle' | 'Cat' | 'Rabbit' | 'Dog' | 'Turtle' | 'Squirrel' | 'Fish' | 'Elephant' | 'Lion' | 'Snake' | 'Bear' | 'Dinosaur') => {
  ...
  const handleRebuild = (type: 'Eagle' | 'Cat' | 'Rabbit' | 'Twins' | 'Dog' | 'Turtle' | 'Squirrel' | 'Fish' | 'Elephant' | 'Lion' | 'Snake' | 'Bear' | 'Dinosaur') => {
    const generator = Generators[type];
    if (generator && engineRef.current) {
